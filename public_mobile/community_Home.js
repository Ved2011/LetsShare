...
function displayItems(items) {
    ...
    communityItemsGrid.innerHTML = items.map(item => `
        <div class="community-card" onclick="window.location.href='item_View.html?id=${item.id}'" style="background: var(--card-bg); border: 1px solid var(--border); padding: 1rem; border-radius: 12px; cursor: pointer; transition: transform 0.2s;">
